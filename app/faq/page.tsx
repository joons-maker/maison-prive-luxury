...
const faqs = [
  ...
  {
    q: "결제는 어떻게 진행되나요?",
    a: "문의 접수만으로 구매가 확정되거나 결제가 청구되지 않습니다. 현지 재고 확인 후 Private Brief(견적)를 발송하고, 고객님께서 승인하신 경우에만 결제 요청서가 발행됩니다. 현재는 무통장 입금(계좌이체) 방식으로 안내드리며, 카드결제(PG)는 추후 도입될 예정입니다. 결제 요청 내역과 계좌 안내는 접수 시 발급된 Request ID로 /track 페이지에서 확인하실 수 있습니다.",
  },
  {
    q: "환불이나 취소는 어떻게 되나요?",
    a: "고객 승인 전, 즉 결제 요청서 발행 전까지는 언제든 취소하실 수 있으며 어떠한 비용도 발생하지 않습니다. 입금 후 현지 공식 부티크에서 구매가 완료된 이후에는 제품 특성상 교환·환불이 어렵습니다. 현지 확인 결과 재고가 없거나 의뢰 조건과 맞지 않는 경우 진행 전 반드시 고객 확인을 받으므로, 실물 미확인 상태로 결제가 진행되는 경우는 없습니다.",
  },
  {
    q: "배송은 얼마나 걸리나요?",
  ...
  {
    q: "선호 브랜드나 관심 제품을 미리 등록할 수 있나요?",
    a: "네, VIP 문의 폼 하단의 'VIP Preference Profile'에서 선호 브랜드·색상·사이즈·구매 목적 등을 등록하실 수 있으며, 'Private Wishlist'에 관심 제품을 최대 3개까지 미리 등록하실 수 있습니다. 등록하신 정보는 담당 컨시어지가 현지 확인 시 함께 참고합니다.",
  },
];
